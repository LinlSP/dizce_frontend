          ...
          <div className="container">
            ...
            >
              ...
              <MainTitle>
                <FirstLine>
                  {maintitle.big1}
                  <LittleMainTitle>{maintitle.mini}</LittleMainTitle>
                </FirstLine>
                {maintitle.big2}
              </MainTitle>
              <MainButton to="/services">{maintitle.button}</MainButton>
              <WorldIcon>
                <SelectLangBox on={langBox ? 1 : 0}>
                  {languages.map((language, index) => (
                    <LangInBox
                      key={index}
                      onClick={() => {
                        changeLanguage(index, window.location.reload());
                      }}
                    >
                      {language}
                    </LangInBox>
